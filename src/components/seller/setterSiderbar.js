...
function SellerSidebar(props){
    return (
            <div className="list-group">
                    ...
                    <Link to="/manage-categories" className="list-group-item list-group-item-action">Manage Categories</Link>
                    <Link to="/manage-products" className="list-group-item list-group-item-action">Manage Products</Link>
